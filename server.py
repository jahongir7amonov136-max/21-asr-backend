...
# JWT Secret uchun vaqtincha biror tekst qo'yib turing (Vercel-da buni alohida sozlaymiz)
JWT_SECRET = os.environ.get("JWT_SECRET", "21-asr-secret-key-super-strong-123")
JWT_ALGORITHM = "HS256"
